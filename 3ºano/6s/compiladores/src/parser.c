...
{
       0,    85,    85,    86,    89,    90,    93,    97,   104,   113,
     120,   127,   134,   141,   149,   155,   163,   171,   178,   185,
     192,   199,   206,   213,   221,   230,   237,   244,   251,   258,
     265,   272,   281,   292,   299,   306,   313,   320,   330,   337,
     344,   351,   360,   368,   374,   381,   388,   394,   402,   409,
     415,   423,   430,   439,   446,   455,   462,   469,   476,   483,
     491,   495,   498,   503,   509,   515,   521,   527,   533,   539,
     545
};
#endif
...
yyreduce:
  ...
  case 3:
#line 86 "ya.y"
                      {prints123();printf("Declaração: program\n");}
#line 1580 "parser.c"
    break;

  case 4:
#line 89 "ya.y"
                         {(yyval.decls) = new_decls((yyvsp[0].decl), (yyvsp[-1].decls));printf("Declaração: decls-> decls decl\n");}
#line 1586 "parser.c"
    break;

  case 5:
#line 90 "ya.y"
                  {(yyval.decls) = new_decls((yyvsp[0].decl), NULL);printf("Declaração: decls-> decl\n");}
#line 1592 "parser.c"
    break;

  case 6:
#line 93 "ya.y"
                         {(yyval.decl) = new_decl((yyvsp[-1].decl1));printf("Declaração: decl-> decl1\n");}
#line 1598 "parser.c"
    break;
